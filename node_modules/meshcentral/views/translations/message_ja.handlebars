...
<body>
    ...
    <script>
        ...
        switch (msgid) {
            ...
            case 2: { msg = "エラー：ユーザー名「{0}」が無効です。"; break; }
            ...
            case 6: { msg = format("ユーザーアカウント{1}の確認済みメール{0}。", '<b>' + arg1 + '</b>', '<b>' + arg2 + '</b>'); break; }
            case 7: { msg = format("ユーザー\"{1}\"の電子メール\"{0}\"は確認されていません。", arg1, arg2); break; }
            case 8: {
                msg = '<div>' + format("アカウント{0}のパスワードは次のようにリセットされました：", '<b>' + arg1 + '</b>') + '</div><div style=padding:14px;font-size:18px><b>' + arg2 + '</b></div>';
        ...
        QH('mainMessage', msg + ' <a href="' + domainurl + '">' + "ログインページに移動" + '</a>.');
