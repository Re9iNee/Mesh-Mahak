    ...
    <div id="main" class="container" style="position:absolute;top:0px;right:0;left:0;bottom:0px">
        <div class="middleContainer">
            ...
            <table class="signinform">
                ...
                <tr>
                    <td><label for="inputUsername" class="formLabel">사용자 이름</label></td>
                    <td style="text-align:right"><input type="text" id="inputUsername" class="formControl" placeholder="사용자 이름"></td>
                </tr>
                <tr>
                    <td><label for="inputPassword" class="formLabel">암호</label></td>
                    <td style="text-align:right"><input type="password" id="inputPassword" class="formControl" placeholder="암호"></td>
                </tr>
                <tr>
                    <td colspan="2"><button class="connectButton" onclick="return connect()">연결</button></td>
                </tr>
            </tbody></table>
        </div>
    </div>
