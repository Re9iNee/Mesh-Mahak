    ...
    <div id="container">
        ...
        <div id="page_content" style="overflow-y:scroll;position:absolute;bottom:32px;top:50px">
            <div id="column_l" style="padding-left:10px;padding-right:10px">
                ...
                <p class="MsoNormal">
                    <span>Deze software bestaat uit vrijwillige bijdragen van veel personen (AUTHORS.txt, http://jqueryui.com/about ). Voor de exacte contributiegeschiedenis, zie de revisiegeschiedenis en logboeken, beschikbaar op http://jquery-ui.googlecode.com/svn/ <o:p></o:p></span>
                </p>
                <p class="MsoNormal">
