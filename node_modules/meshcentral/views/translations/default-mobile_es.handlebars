            ...
            <div id="column_l" style="width:100%;padding:0;position:absolute;bottom:0px;top:0px">
                <div id="p0" style="display:none;width:100%;height:100%">
                    <div style="display:flex;align-items:center;width:100%;height:100%">
                        <div id="p0message" style="text-align:center;width:100%"><span id="p0span">Servidor desconectado</span>, <href onclick="reload()" style="cursor:pointer"><u>Haga clic para volver a conectar</u></href>.</div>
                    </div>
                </div>
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:30px;left:0;right:0;bottom:0px;background-color:#aaa">
                        <div style="margin:4px">
                            ...
                            <input id="SearchInput" type="text" placeholder="Filtrar" onchange="onDeviceSearchChanged(event)" onkeyup="onDeviceSearchChanged(event)" autocomplete="off">&nbsp;
                            ...
                            <label class="noselect"><input type="checkbox" id="OnlineCheckBox" onclick="onOnlineCheckBox(event)">En Linea</label>
                        </div>
                    </div>
                </div>
                <div id="p3" style="display:none;position:absolute;bottom:0;top:0;width:100%">
                    ...
                    <div id="p3info" style="overflow-y:auto;position:absolute;top:55px;bottom:0px;width:100%">
                        <div style="margin-left:8px">
                            <div id="p3AccountActions">
                                <div id="p2AccountSecurity" style="display:none">
                                    ...
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        ...
                                        <div id="manageEmail2FA" style="margin-top:5px;display:none"><a onclick="account_manageAuthEmail()" style="cursor:pointer">Administrar autenticación por mail</a> <span id="authEmailSetupCheck"><strong>✓</strong></span></div>
                                ...
                                <div id="p2AccountActions" style="display:none">
                                    ...
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        ...
                                        <div style="margin-top:5px"><span id="verifyEmailId" style="display:none"><a onclick="account_showVerifyEmail()" style="cursor:pointer">Verificar correo electronico</a></span></div>
                                        <div style="margin-top:5px"><span id="changeEmailId" style="display:none"><a onclick="account_showChangeEmail()" style="cursor:pointer">Cambiar dirección de correo</a></span></div>
                                        ...
                                        <div style="margin-top:5px"><a onclick="account_showDeleteAccount()" style="cursor:pointer">Borrar cuenta</a></div>
                                    </div>
                                <br style="clear:both">
                                </div>
                            </div>
                            ...
                            <br><br>
                            <div id="p3meshes"></div>
                            <div id="p3noMeshFound" style="margin-left:9px;display:none">No hay grupos de dispositivos.<span id="p3createMeshLink2"> <a onclick="account_createMesh()" style="cursor:pointer"><strong>¡Comience aquí!</strong></a></span></div>
                            <br style="clear:both">
                        </div>
                    </div>
                </div>
                            ...
                            <tbody><tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5FolderUp" disabled="disabled" onclick="p5folderup()" value="Arriba">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5DeleteFileButton" disabled="disabled" value="Borrar" onclick="p5deletefile()" onkeypress="return false" onkeydown="return false">
                                    ...
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5UploadButton" disabled="disabled" value="Subir" onclick="p5uploadFile()" onkeypress="return false" onkeydown="return false">
                    ...
                    <div id="p10desktop" style="overflow:hidden;position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:25px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div style="margin-left:3px">
                                    <input type="button" id="connectbutton1" value="Conectar" onclick="connectDesktop(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled">
                                    <input type="button" id="connectbutton1h" value="Conectarse al HW" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled">
                                    <input type="button" id="disconnectbutton1" value="Desconectar" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false">
                        ...
                        <div id="deskarea3" style="position:absolute;top:25px;width:100%;height:calc(100% - 50px)">
                            <div id="deskarea3x" style="background:black;text-align:center;height:100%;position:relative">
                                ...
                                <div id="DeskTools" style="position:absolute;width:400px;height:100%;background-color:gray;top:0;right:0;border-left:2px solid lightgray;display:none">
                                    <a id="DeskToolsRefreshButton" style="float:right;padding:3px;cursor:pointer" onclick="refreshDeskTools()">Actualizar</a>
                                    <div id="DeskToolsBar" style="position:absolute;padding:3px;border-radius: 3px 3px 0px 0px;top:5px;left:4px;bottom:26px;background-color:lightgray;cursor:pointer">Procesos</div>
                                    <div style="position:absolute;top:26px;left:4px;right:4px;bottom:4px;background-color:lightgray;text-align:left">
                                        <div style="border-bottom:1px solid darkgray;padding:3px"><a style="width:50px;padding-right:5px;float:left;cursor:pointer" onclick="sortProcess(0)">PID</a><a style="cursor:pointer" onclick="sortProcess(1)">Nombre</a></div>
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:25px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    <input id="deskActionsBtn" type="button" style="margin-left:3px" onkeypress="return false" onkeydown="return false" value="Acciones" onclick="deviceActionFunction()">
                                    <input type="button" value="Configuraciones" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()">
                                    <input type="button" onkeypress="return false" onkeydown="return false" value="Acciones de encendido ..." onclick="showPowerActionDlg()" style="display:none">
                                    <input type="button" id="DeskSpecialKeys" value="Llaves" onkeypress="return false" onkeydown="return false" onclick="sendSpecialKeys()">
                                    <input type="button" id="DeskSoftKeys" value="Teclado" onkeypress="return false" onkeydown="return false" onclick="toggleSoftKeys(1)">
                                    <input type="button" id="DeskScreens" value="Pantallas" onkeypress="return false" onkeydown="return false" onclick="deskSelectScreens()" style="display:none">
                    ...
                    <div id="p10files" style="position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <table id="p13toolbar" style="width:100%;height:111px" cellpadding="0" cellspacing="0">
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px">
                                    ...
                                    <div style="margin-left:2px">
                                        <input id="p13AutoConnect" value="Auto Conectarse" onclick="autoConnectFiles(event)" onkeypress="return false" onkeydown="return false" type="button" style="display:none">
                            ...
                            <tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Arriba">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13DeleteFileButton" disabled="disabled" value="Borrar" onclick="p13deletefile()" onkeypress="return false" onkeydown="return false">
                                    ...
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13UploadButton" disabled="disabled" value="Subir" onclick="p13uploadFile()" onkeypress="return false" onkeydown="return false">
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    ...
                    <div style="margin:3px 0 3px 0">
                        ...
                        <div style="height:20px">Calidad</div>
                    </div>
                    <div style="margin:3px 0 3px 0">
                    ...
                    <div style="margin:3px 0 3px 0">
                        ...
                        <div style="height:20px">Velocidad</div>
                    </div>
                </div>
                <div id="d7amtkvm">
                    ...
                    <div style="height:60px">
                        <div style="float:right;border:1px solid #666;width:200px;height:60px;overflow-y:scroll;background-color:white">
                            <label><input type="checkbox" id="d7showfocus">Mostrar herramienta de enfoque</label><br>
                            <label><input type="checkbox" id="d7showcursor">Mostrar cursor del mouse local</label><br>
                        </div>
                        <div>Otros</div>
                    </div>
                </div>
    ...
    <script>
        ...
        function onMessage(server, message) {
            switch (message.action) {
                ...
                case 'otpauth-clear': {
                    if (xxdialogMode) return;
                    setDialogMode(2, "Aplicación de autenticación", 1, null, message.success ? "<b style=color:green>Activación de inicio de sesión de 2 pasos eliminada</b>. Puede reactivar esta funcion en cualqueir momento." : "<b style=color:red>Error al eliminar la activación del segundo factor de autenticación</b>. Inténtalo de nuevo.");
                    break;
                }
                case 'otpauth-getpasswords': {
                    ...
                    x += '<input type=button value=\'' + "Nuevo Token" + '\' onclick=\'account_manageOtp(1);\'></input>';
        ...
        function account_showChangePassword() {
            ...
            if (passRequirements) {
                ...
                if (rc > 0) { x += '<br /><span style=font-size:x-small>' + format("Requirimientos: {0}.", r.join(', ')) + '</span>'; }
            }
            x += '<br />';
        ...
        function account_createMesh() {
            ...
            x += addHtmlValue("Tipo", '<div style=width:170px;margin:0;padding:0><select id=dp3meshtype style=width:100% onchange=account_validateMeshCreate() ><option value=2>' + "Grupo Agentes de Software" + '</option><option value=1>' + "Intel & reg; Solo AMT" + '</option></select></div>');
        ...
        function getNiceSize(bytes) {
            ...
            if (bytes < 2048) return format("Quedan {0}b ", bytes);
            if (bytes < 2097152) return format("Quedan {0}k", Math.round(bytes / 1024));
            if (bytes < 2147483648) return format("Quedan {0}m", Math.round(bytes / 1024 / 1024));
            return format("Quedan {0}g", Math.round(bytes / 1024 / 1024 / 1024));
        }
        ...
        function p5showPublicLink(u) { setDialogMode(2, "Enlace publico", 1, null, '<input type=text style=width:100% value="' + u + '" readonly />'); }
        ...
        function getFileSizeStr(size) { if (size == 1) return "Un byte"; return format("{0} bytes", size); }
        ...
        function updateDevicesEx() {
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype == 1) { r += '<div style=padding:10px><i>' + "Sin Intel & reg; Dispositivos AMT en este grupo"; }
                        if (mesh.mtype == 2) { r += '<div style=padding:10px><i>' + "No hay dispositivos en este grupo."; }
                        r += '.</i></div></div>';
                        current = mesh._id;
                        count++;
                    }
            ...
            if (count == 0) {
                QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Sin dispositivos" + '</span><br /><br />' + "Use la versión de escritorio de este sitio web para agregar dispositivos." + '</div>');
            } else {
                QH('xdevices', r);
            }
            deviceHeaderSet();
                ...
                if ((devdivs[i].offsetTop >= visibleTop) && (devdivs[i].offsetTop < visibleBottom)) {
                    ...
                    if (node.sessions != null) {
                        ...
                        if (node.sessions.battery != null) {
                            ...
                            else if (bat.state == 'dc') { statestr = "La batería del dispositivo esta conectada"; }
        ...
        var powerStateStrings = ['', "Encendido", "Durmiendo", "Durmiendo", "Sueño profundo", "Hibernando", "Soft-Off", "Presente"];
        ...
        function NodeStateStr(node) {
            ...
            if (node.conn) {
                if ((node.conn & 1) != 0) { states.push('<span>' + "Agente" + '</span>'); }
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if ((node.agent != null) && (node.agent.id != null) && (node.agent.ver != null)) {
                    ...
                    x += addDeviceAttribute("Agente", str);
                }
                ...
                if (node.intelamt != null) {
                    ...
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("Estado desconocido") + '</i>, v' + EscapeHtml(node.intelamt.ver); } else
                    ...
                    if (node.intelamt.state == 2) {
                        if (node.intelamt.user == null || node.intelamt.user == '') {
                            if ((meshrights & 4) != 0) {
                                str += ', <i style=color:#FF0000;cursor:pointer onclick=editDeviceAmtSettings("' + node._id + '")>' + nobreak("Sin credenciales") + '</i>';
                            } else {
                ...
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("Etiquetas", '<span onclick=showEditNodeValueDialog(3) style=cursor:pointer>' + groupingTags + '</span>');
                } else {
                    x += addDeviceAttribute("Etiquetas", groupingTags);
                }

                x += '</table><br />';
                // Show action button, only show if we have permissions 4, 8, 64
                if ((meshrights & 76) != 0) { x += '<input type=button value=\"' + "Acciones" + '\" onclick=deviceActionFunction() />'; }
                ...
                if ((meshrights & 0x8000) != 0) { x += '<a style=cursor:pointer onclick=p10showDeleteNodeDialog("' + node._id + '")>' + "Borrar dispositivo" + '</a>'; }
                ...
                if ((connectivity & 1) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += '<span style=font-size:10px>' + "Agente Mesh" + '</span>'; }
                if ((connectivity & 2) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += '<span style=font-size:10px>' + "Intel&reg; AMT conectado" + '</span>'; }
                else if ((connectivity & 4) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += '<span style=font-size:10px>' + "Intel & reg; AMT detectado" + '</span>'; }
                if ((connectivity & 16) != 0) { if (powerstate.length > 0) { powerstate += '<br/>'; } powerstate += '<span style=font-size:12px>' + "Canal MQTT conectado" + '</span>'; }
        ...
        function deviceToastFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Dispositivo tostado", 3, deviceToastFunctionEx, '<textarea id=d2devToast style=width:100%;height:80px;resize:none;overflow-y:scroll></textarea>');
        }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype == 2) && (currentNode.agent.caps & 4))) { menus.push({ n: "Archivos", f: 'setupDeviceMenu(2)' }); }
            if ((currentDevicePanel != 3) && (currentNode != null)) { menus.push({ n: "Detalles", f: 'setupDeviceMenu(3)' }); }
        ...
        function deviceActionFunction() {
            ...
            if ((meshrights & 64) != 0) { y += '<option value=100>' + "Despertar" + '</option>'; } // Wake-up permission
            if ((meshrights & 8) != 0) { y += '<option value=4>' + "Dormir" + '</option><option value=3>' + "Reiniciar" + '</option><option value=2>' + "Apagar" + '</option>'; } // Remote control permission
            y += '</select>';
        ...
        function editDeviceAmtSettings(nodeid, func) {
            ...
            x += addHtmlValue("Usuario", '<input id=dp10username style=width:170px maxlength=32 autocomplete=nope placeholder="admin" onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            ...
            x += addHtmlValue("Seguridad", '<select id=dp10tls style=width:176px><option value=0>' + "Sin Seguridad TLS" + '</option><option value=1>' + "Seguridad TLS requerida" + '</option></select>');
            if ((node.intelamt.user != null) && (node.intelamt.user != '')) { buttons = 7; }
            setDialogMode(2, "Editar Credenciales de Intel & AMT", buttons, editDeviceAmtSettingsEx, x, { node: node, func: func });
        ...
        function p10showDeleteNodeDialog(nodeid) {
            if (xxdialogMode) return;
            setDialogMode(2, "Borrar Nodo", 3, p10showDeleteNodeDialogEx, format("Borrar {0}?", EscapeHtml(currentNode.name)) + '<br /><br /><label><input id=p10check type=checkbox onchange=p10validateDeleteNodeDialog() />' + "Confirme" + '</label>', nodeid);
        ...
        */
        ...
        function deskSelectScreens() {
            ...
            setDialogMode(2, "Seleccionar pantalla", 3, deskSelectScreensEx, x);
        }
        ...
        */
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            if ((hardware.windows && hardware.windows.osinfo) || node.osdesc) {
                ...
                if (x != '') { sections.push({ name: "Sistema operativo", html: x, img: 'software32.png' }); }
            }
            ...
            if (node.agent) {
                ...
                if (x != '') { sections.push({ name: "Agente Mesh", html: x, img: 'meshagent32.png' }); }
            }
            ...
            if (hardware.identifiers) {
                ...
                if (x != '') { sections.push({ name: "Placa Madre", html: x, img: 'motherboard32.png' }); }
            }
            ...
            if (hardware.windows) {
                if (hardware.windows.memory) {
                    ...
                    if (x != '') { sections.push({ name: "Memoria", html: x, img: 'ram32.png' }); }
                }
            }
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                if (x != '') { sections.push({ name: "Almacenamiento", html: x, img: 'storage32.png' }); }
            }
        ...
        function p20updateMesh() {
            ...
            if (currentMeshLinks && ((currentMeshLinks.rights & 2) != 0)) { x += '<div style=margin-bottom:6px><a onclick=p20showAddMeshUserDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Agregar Usuario" + '</a></div>'; }
            ...
            */
            ...
            for (var i in sortedusers) {
                var trash = '', rights = "Privilegios Parciales", r = sortedusers[i].rights, icon = 2;
                if (r == 0xFFFFFFFF) rights = "Administrador Completo"; else if (r == 0) rights = "Sin Acceso";
            ...
            if (meshrights == 0xFFFFFFFF) { x += '<div style=font-size:small;text-align:right;margin-top:6px><span><a onclick=p20showDeleteMeshDialog() style=cursor:pointer>' + "Borrar Grupo" + '</a></span></div>'; }
        ...
        function p20viewuser(userid) {
            ...
            if (meshrights == 0xFFFFFFFF) r.push("Administrador Completo"); else {
                ...
                if ((meshrights & 256) != 0) r.push("Vista remota solamente");
        ...
        function p20viewuserEx(button, userid) {
            ...
            setDialogMode(2, "Usuario Mesh remoto", 3, p20viewuserEx2, format("¿Eliminae el usuario {0}?", uname), userid);
        }
