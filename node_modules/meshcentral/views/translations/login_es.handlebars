...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" class="arg_hide login">
    <div id="container">
        ...
        <div id="column_l">
            <h1>Bienvenido {0}.</h1>
            <div id="welcomeText" style="display:none">Conéctese a los dispositivos de su hogar u oficina desde cualquier parte del mundo utilizando MeshCentral, el sitio web de administración y monitoreo remoto de código abierto en tiempo real. Deberá descargar e instalar un agente de administración en sus computadoras. Una vez instaladas, las computadoras aparecerán en la sección "Mis dispositivos" de este sitio web y usted podrá monitorearlas y controlarlas.</div>
                    ...
                    <td id="logincell">
                        <div id="loginpanel" style="display:none">
                            <form method="post">
                                ...
                                <table>
                                    <tbody><tr>
                                        <td id="loginusername" align="right" width="100">Usuario:</td>
                                ...
                                <div id="newAccountDiv" style="display:none;padding:2px">
                                    No tienes una cuenta? <a onclick="return xgo(2,event);" href="#" style="cursor:pointer">Crea uno</a>.
                                </div>
                                <input id="loginformargs" name="urlargs" type="hidden" value="">
                                <div id="authStrategies" style="display:none">
                                    <hr>
                                    <div style="margin-bottom:8px">Ingresar usando una cuenta existente</div>
                                    ...
                                    <a id="auth-reddit" href="auth-reddit" style="display:none"><img src="images/login/reddit32.png" loading="lazy" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Ingresar usando Reddit"></a>
                                    ...
                                    <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" loading="lazy" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Ingresar usando Intel"></a>
                                    <a id="auth-saml" href="auth-saml" style="display:none"><img src="images/login/generic32.png" loading="lazy" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Inicio de sesión simple"></a>
                                </div>
                            </form>
                        </div>
                            ...
                            <form method="post">
                                ...
                                <table>
                                    <tbody><tr id="nuUserRow">
                                        <td id="nuUser" align="right" width="100">Usuario:</td>
                                    ...
                                    <tr id="newAccountPass" title="Ingrese el token de creación de cuenta">
                                        <td id="nuToken" align="right">Creación de Token:</td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="float:right"><input id="createButton" type="submit" value="Crear una cuenta" disabled="disabled"></div>
                                            <div id="passWarning" style="padding-top:6px"></div>
                                        </td>
                                    </tr>
                                </tbody></table>
                                <hr><a onclick="return xgo(1,event);" href="#" style="cursor:pointer">Regresar al Inicio de Sesion</a>
    ...
    <script>
        ...
        function startup() {
            ...
            if (twoFactorCookieDays > 0) {
                ...
                QH('tokenInputRememberSpan', format("Recuerde este dispositivo durante {0} días.", twoFactorCookieDays));
            } else {
            ...
            if (features & 0x200000) { // Email is username
                ...
                QH('resetAccountSpan', "¿Olvidaste tu contraseña?");
                QV('nuUserRow', false);
            }
        ...
        function useEmailToken() {
            ...
            setDialogMode(1, "Inicio de sesión seguro", 3, useEmailKeyEx, "¿Enviar token para registrar la dirección de correo electrónico?");
        }
        ...
        function validateCreate(box, e) {
            ...
            if (Q('apassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    else { QH('passWarning', '<span style=color:red><b>' + "Contraseña debil" + '</b><span>'); }
                } else {
        ...
        function validatePassReset(box, e) {
            ...
            if (Q('rapassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    else { QH('rpassWarning', '<span style=color:red><b>' + "Contraseña debil" + '</b><span>'); }
                } else {
                    // Password requirements provided, use that
        ...
        function passwordPolicyText(pass) {
            ...
            if (passRequirements.upper && ((pass == null) || (counts.upper < passRequirements.upper))) { policy += format("{0} mayuscula", passRequirements.upper) + '<br />'; }
