            ...
            <div id="column_l" style="width:100%;padding:0;position:absolute;bottom:0px;top:0px">
                <div id="p0" style="display:none;width:100%;height:100%">
                    <div style="display:flex;align-items:center;width:100%;height:100%">
                        <div id="p0message" style="text-align:center;width:100%"><span id="p0span">服務器已斷開連接</span>, <href onclick="reload()" style="cursor:pointer"><u>點擊重新連接</u></href>.</div>
                    </div>
                </div>
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:30px;left:0;right:0;bottom:0px;background-color:#aaa">
                        <div style="margin:4px">
                            ...
                            <input id="SearchInput" type="text" placeholder="過濾" onchange="onDeviceSearchChanged(event)" onkeyup="onDeviceSearchChanged(event)" autocomplete="off">&nbsp;
                ...
                <div id="p3" style="display:none;position:absolute;bottom:0;top:0;width:100%">
                    ...
                    <div id="p3info" style="overflow-y:auto;position:absolute;top:55px;bottom:0px;width:100%">
                        <div style="margin-left:8px">
                            <div id="p3AccountActions">
                                <div id="p2AccountSecurity" style="display:none">
                                    ...
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        ...
                                        <div id="manageEmail2FA" style="margin-top:5px;display:none"><a onclick="account_manageAuthEmail()" style="cursor:pointer">管理電子郵件身份驗證</a> <span id="authEmailSetupCheck"><strong>✓</strong></span></div>
                                        <div id="manageAuthApp" style="margin-top:5px;display:none"><a onclick="account_manageAuthApp()" style="cursor:pointer">管理身份驗證器應用</a> <span id="authAppSetupCheck"><strong>✓</strong></span></div>
                                ...
                                <div id="p2AccountActions" style="display:none">
                                    ...
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        ...
                                        <div style="margin-top:5px"><span id="verifyEmailId" style="display:none"><a onclick="account_showVerifyEmail()" style="cursor:pointer">驗證郵件</a></span></div>
                                        <div style="margin-top:5px"><span id="changeEmailId" style="display:none"><a onclick="account_showChangeEmail()" style="cursor:pointer">更改電子郵件地址</a></span></div>
                            ...
                            <br><br>
                            <div id="p3meshes"></div>
                            <div id="p3noMeshFound" style="margin-left:9px;display:none">沒有設備組。<span id="p3createMeshLink2"> <a onclick="account_createMesh()" style="cursor:pointer"><strong>從這裡開始！</strong></a></span></div>
                            <br style="clear:both">
                        </div>
                    </div>
                </div>
                            ...
                            <tbody><tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5NewFolderButton" disabled="disabled" value="夾" onclick="p5createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                    ...
                    <div id="p10desktop" style="overflow:hidden;position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:25px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div style="margin-left:3px">
                                    <input type="button" id="connectbutton1" value="連接" onclick="connectDesktop(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled">
                                    <input type="button" id="connectbutton1h" value="硬件連接" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled">
                                    <input type="button" id="disconnectbutton1" value="斷開" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false">
                                    <span id="deskstatus">斷線</span>
                                </div>
                            </div>
                        </div>
                        <div id="deskarea3" style="position:absolute;top:25px;width:100%;height:calc(100% - 50px)">
                            <div id="deskarea3x" style="background:black;text-align:center;height:100%;position:relative">
                                ...
                                <div id="DeskTools" style="position:absolute;width:400px;height:100%;background-color:gray;top:0;right:0;border-left:2px solid lightgray;display:none">
                                    <a id="DeskToolsRefreshButton" style="float:right;padding:3px;cursor:pointer" onclick="refreshDeskTools()">刷新</a>
                                    <div id="DeskToolsBar" style="position:absolute;padding:3px;border-radius: 3px 3px 0px 0px;top:5px;left:4px;bottom:26px;background-color:lightgray;cursor:pointer">工藝流程</div>
                                    <div style="position:absolute;top:26px;left:4px;right:4px;bottom:4px;background-color:lightgray;text-align:left">
                                        <div style="border-bottom:1px solid darkgray;padding:3px"><a style="width:50px;padding-right:5px;float:left;cursor:pointer" onclick="sortProcess(0)">PID</a><a style="cursor:pointer" onclick="sortProcess(1)">名稱</a></div>
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:25px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    <input id="deskActionsBtn" type="button" style="margin-left:3px" onkeypress="return false" onkeydown="return false" value="動作" onclick="deviceActionFunction()">
                                    <input type="button" value="設定值" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()">
                                    <input type="button" onkeypress="return false" onkeydown="return false" value="電源動作..." onclick="showPowerActionDlg()" style="display:none">
                                    <input type="button" id="DeskSpecialKeys" value="按鍵" onkeypress="return false" onkeydown="return false" onclick="sendSpecialKeys()">
                                    <input type="button" id="DeskSoftKeys" value="鍵盤" onkeypress="return false" onkeydown="return false" onclick="toggleSoftKeys(1)">
                                    <input type="button" id="DeskScreens" value="屏風" onkeypress="return false" onkeydown="return false" onclick="deskSelectScreens()" style="display:none">
                                    <label><span id="DeskControlSpan" style="display:none"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false">輸入值</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13NewFolderButton" disabled="disabled" value="夾" onclick="p13createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    ...
                    <div style="margin:3px 0 3px 0">
                        ...
                        <div style="height:20px">縮放比例</div>
                    </div>
                    <div style="margin:3px 0 3px 0">
                        ...
                        <div style="height:20px">率</div>
                    </div>
                </div>
                <div id="d7amtkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">英特爾®AMT硬件KVM</h4>
                    ...
                    <div style="height:60px">
                        <div style="float:right;border:1px solid #666;width:200px;height:60px;overflow-y:scroll;background-color:white">
                            <label><input type="checkbox" id="d7showfocus">顯示焦點工具</label><br>
                            <label><input type="checkbox" id="d7showcursor">顯示本地鼠標光標</label><br>
                        </div>
                        <div>其他</div>
                    </div>
                </div>
    ...
    <script>
        ...
        function onStateChanged(server, state, prevState, errorCode) {
            if (state == 0) {
                ...
                if (prevState == 2) { setTimeout(serverPoll, 5000); } else { QH('p0span', "無法連接網絡套接字"); }
                // Clean up here
        ...
        function onMessage(server, message) {
            switch (message.action) {
                ...
                case 'otpauth-setup': {
                    ...
                    setDialogMode(2, "身份驗證器應用", 1, null, message.success ? "<b style = color：green>兩步登錄激活成功</ b>。您現在需要一個有效的令牌才能再次登錄。" : "<b style = color：red>兩步登錄激活失敗</ b>。從應用程序中清除秘密，然後重試。您只有幾分鐘的時間來輸入正確的代碼。");
                    break;
                }
                case 'otpauth-clear': {
                    if (xxdialogMode) return;
                    setDialogMode(2, "身份驗證器應用", 1, null, message.success ? "<b style = color：green>刪除了兩步登錄激活</ b>。您可以隨時重新激活此功能。" : "<b style = color：red>兩步登錄激活刪除失敗</ b>。再試一次。");
                    break;
                }
                case 'otpauth-getpasswords': {
                    ...
                    x += '<input type=button value=\'' + "新代幣" + '\' onclick=\'account_manageOtp(1);\'></input>';
                    if (message.passwords != null) { x += '<input type=button value=\'' + "明確" + '\' onclick=\'account_manageOtp(2);\'></input>'; }
                    x += '</div><br />';
        ...
        function account_showChangeEmail() {
            if (xxdialogMode) return;
            var x = addHtmlValue("電子郵件", '<input id=dp3email style=width:170px maxlength=256 onchange=account_validateEmail() onkeyup=account_validateEmail(event) />');
        ...
        function account_createMesh() {
            ...
            if ((userinfo.siteadmin != 0xFFFFFFFF) && ((userinfo.siteadmin & 64) != 0)) { setDialogMode(2, "新設備組", 1, null, "此帳戶無權創建新的設備組。"); return; }

            // Remind the user to verify the email address
            if ((userinfo.emailVerified !== true) && (serverinfo.emailcheck == true) && (userinfo.siteadmin != 0xFFFFFFFF)) { setDialogMode(2, "帳號安全", 1, null, "在驗證電子郵件地址之前，無法訪問設備。這是密碼恢復所必需的。轉到“我的帳戶”以更改並驗證電子郵件地址。"); return; }

            // Remind the user to add two factor authentication
            if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "帳號安全", 1, null, "在啟用兩因素身份驗證之前，無法訪問設備。這是額外的安全性所必需的。轉到“我的帳戶”，然後查看“帳戶安全性”部分。"); return; }
            ...
            x += addHtmlValue("類型", '<div style=width:170px;margin:0;padding:0><select id=dp3meshtype style=width:100% onchange=account_validateMeshCreate() ><option value=2>' + "軟件代理組" + '</option><option value=1>' + "僅限英特爾&reg;AMT" + '</option></select></div>');
            ...
            setDialogMode(2, "創建設備組", 3, account_createMeshEx, x);
        ...
        function updateFiles() {
            ...
            var html1 = '', html2 = '', displayPath = '<a style=cursor:pointer onclick=p5folderup(0)>' + "根" + '</a>', fullPath = 'Root', publicPath, filetreex = filetree, folderdepth = 1;
            ...
            for (var i in filetreexx) {
                ...
                if (f.t < 3 || f.t == 4) {
                    ...
                    var link = shortname;
                    var publiclink = '';
                    if (publicfolder) { publiclink = ' (<a style=cursor:pointer onclick=\'p5showPublicLink("' + publicPath + '/' + f.nx + '")\'>' + "鏈接" + '</a>)'; }
        ...
        function getNiceSize(bytes) {
            ...
            if (bytes < 2147483648) return format("還有{0} m", Math.round(bytes / 1024 / 1024));
        ...
        function p5showPublicLink(u) { setDialogMode(2, "公開連結", 1, null, '<input type=text style=width:100% value="' + u + '" readonly />'); }
        ...
        function getFileSizeStr(size) { if (size == 1) return "1個字節"; return format("{0}個字節", size); }
        ...
        function updateDevicesEx() {
            ...
            for (var i in nodes) {
                ...
                if (sort == 0) {
                    ...
                    if (((meshes[nodes[i].meshid]?nodes[i].meshid:'*') != current)) {
                        deviceHeaderSet();
                        var extra = '';
                        if ((meshes[nodes[i].meshid] != null) && (meshes[nodes[i].meshid].mtype == 1)) { extra = '<span style=color:lightgray>' + "，僅限Intel&reg;AMT" + '</span>'; }
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype == 1) { r += '<div style=padding:10px><i>' + "該組中沒有英特爾&reg;AMT設備"; }
                        if (mesh.mtype == 2) { r += '<div style=padding:10px><i>' + "該組中沒有設備"; }
                        r += '.</i></div></div>';
                        current = mesh._id;
                        count++;
                    }
            ...
            if (count == 0) {
                QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "沒有裝置" + '</span><br /><br />' + "使用此網站的桌面版本添加設備。" + '</div>');
            } else {
                QH('xdevices', r);
            }
            deviceHeaderSet();
                ...
                if ((devdivs[i].offsetTop >= visibleTop) && (devdivs[i].offsetTop < visibleBottom)) {
                    ...
                    if (node.sessions != null) {
                        ...
                        if (node.sessions.battery != null) {
                            ...
                            else if (bat.state == 'dc') { statestr = "設備由電池供電"; }
        ...
        var powerStateStrings = ['', "供電", "睡眠", "睡眠", "沉睡", "冬眠", "軟關", "當下"];
        ...
        function NodeStateStr(node) {
            ...
            if (node.conn) {
                if ((node.conn & 1) != 0) { states.push('<span>' + "代理商" + '</span>'); }
                if ((node.conn & 2) != 0) { states.push('<span>' + "CIRA" + '</span>'); }
                else if ((node.conn & 4) != 0) { states.push('<span>' + "英特爾&reg;AMT" + '</span>'); }
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                // Attribute: Mesh
                if (mesh) { x += addDeviceAttribute('<span>' + "組" + '</span>', '<a onclick=goForward("' + node.meshid + '") style=cursor:pointer>' + EscapeHtml(meshes[node.meshid].name) + '</a>'); }
                ...
                if (node.intelamt != null) {
                    ...
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("未知狀態") + '</i>, v' + EscapeHtml(node.intelamt.ver); } else
                    ...
                    if (node.intelamt.state == 2) {
                        if (node.intelamt.user == null || node.intelamt.user == '') {
                            if ((meshrights & 4) != 0) {
                                str += ', <i style=color:#FF0000;cursor:pointer onclick=editDeviceAmtSettings("' + node._id + '")>' + nobreak("沒有憑證") + '</i>';
                            } else {
                    ...
                    var meName = "英特爾&reg;ME";
                    if (typeof node.intelamt.sku == 'number') {
                        if ((node.intelamt.sku & 8) != 0) { meName = "英特爾&reg;AMT"; }
                        else if ((node.intelamt.sku & 16) != 0) { meName = "英特爾&reg;SM"; }
                    }
                ...
                if (connectivity && connectivity > 1) {
                    var cstate = [];
                    if ((node.conn & 1) != 0) cstate.push('<span>' + "代理商" + '</span>');
                    if ((node.conn & 2) != 0) cstate.push('<span>' + "英特爾&reg;AMT CIRA" + '</span>');
                    else if ((node.conn & 4) != 0) cstate.push('<span>' + "英特爾&reg;AMT" + '</span>');
                ...
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("標籤", '<span onclick=showEditNodeValueDialog(3) style=cursor:pointer>' + groupingTags + '</span>');
                } else {
                    x += addDeviceAttribute("標籤", groupingTags);
                }

                x += '</table><br />';
                // Show action button, only show if we have permissions 4, 8, 64
                if ((meshrights & 76) != 0) { x += '<input type=button value=\"' + "動作" + '\" onclick=deviceActionFunction() />'; }
                ...
                if ((connectivity & 1) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += '<span style=font-size:10px>' + "網格代理" + '</span>'; }
                if ((connectivity & 2) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += '<span style=font-size:10px>' + "英特爾&reg;AMT已連接" + '</span>'; }
                else if ((connectivity & 4) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += '<span style=font-size:10px>' + "檢測到英特爾&reg;AMT" + '</span>'; }
                if ((connectivity & 16) != 0) { if (powerstate.length > 0) { powerstate += '<br/>'; } powerstate += '<span style=font-size:12px>' + "MQTT通道已連接" + '</span>'; }
        ...
        function deviceToastFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "設備吐司", 3, deviceToastFunctionEx, '<textarea id=d2devToast style=width:100%;height:80px;resize:none;overflow-y:scroll></textarea>');
        }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype == 2) && (currentNode.agent.caps & 4))) { menus.push({ n: "檔案", f: 'setupDeviceMenu(2)' }); }
            if ((currentDevicePanel != 3) && (currentNode != null)) { menus.push({ n: "細節", f: 'setupDeviceMenu(3)' }); }
        ...
        function deviceActionFunction() {
            ...
            if ((meshrights & 64) != 0) { y += '<option value=100>' + "醒來" + '</option>'; } // Wake-up permission
            if ((meshrights & 8) != 0) { y += '<option value=4>' + "睡覺" + '</option><option value=3>' + "重啟" + '</option><option value=2>' + "斷電" + '</option>'; } // Remote control permission
            y += '</select>';
        ...
        function editDeviceAmtSettings(nodeid, func) {
            ...
            x += addHtmlValue("安全", '<select id=dp10tls style=width:176px><option value=0>' + "沒有TLS安全性" + '</option><option value=1>' + "需要TLS安全" + '</option></select>');
            if ((node.intelamt.user != null) && (node.intelamt.user != '')) { buttons = 7; }
            setDialogMode(2, "編輯英特爾&reg;AMT憑據", buttons, editDeviceAmtSettingsEx, x, { node: node, func: func });
        ...
        var showEditNodeValueDialog_modes3 = ['', '', '', "組1，組2，組3"];
        ...
        */
        ...
        function p13updateFiles(checkedNames) {
            var html1 = '', html2 = '', displayPath = '<a style=cursor:pointer onclick=p13folderup(0)>' + "根" + '</a>', fullPath = 'Root';
        ...
        */
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            if ((hardware.windows && hardware.windows.osinfo) || node.osdesc) {
                ...
                if (x != '') { sections.push({ name: "操作系統", html: x, img: 'software32.png' }); }
            }
            ...
            if (node.agent) {
                ...
                if (x != '') { sections.push({ name: "網格代理", html: x, img: 'meshagent32.png' }); }
            }
            ...
            if (node.intelamt != null) {
                ...
                if (x != '') { sections.push({ name: "英特爾&reg;主動管理技術（英特爾&reg;AMT）", html: x, img: 'amt32.png' }); }
            }
            ...
            if (hardware.identifiers) {
                ...
                if (x != '') { sections.push({ name: "的BIOS", html: x, img: 'chip32.png' }); }
                ...
                if (x != '') { sections.push({ name: "母板", html: x, img: 'motherboard32.png' }); }
            }
            ...
            if (hardware.windows) {
                if (hardware.windows.memory) {
                    ...
                    if (x != '') { sections.push({ name: "記憶", html: x, img: 'ram32.png' }); }
                }
            }
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                if (x != '') { sections.push({ name: "存儲", html: x, img: 'storage32.png' }); }
            }
        ...
        function p20updateMesh() {
            ...
            if (currentMeshLinks && ((currentMeshLinks.rights & 2) != 0)) { x += '<div style=margin-bottom:6px><a onclick=p20showAddMeshUserDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "添加用戶" + '</a></div>'; }
            ...
            */
            ...
            for (var i in sortedusers) {
                var trash = '', rights = "部分權利", r = sortedusers[i].rights, icon = 2;
                if (r == 0xFFFFFFFF) rights = "正式管理員"; else if (r == 0) rights = "沒有權利";
        ...
        function p20viewuser(userid) {
            ...
            if (meshrights == 0xFFFFFFFF) r.push("正式管理員"); else {
                ...
                if ((meshrights & 1024) != 0) r.push("沒有文件");
                if ((meshrights & 2048) != 0) r.push("沒有英特爾&reg;AMT");
            ...
            if (uname != userid.split('/')[2]) { x += addHtmlValue("用戶身份", EscapeHtml(userid.split('/')[2])); }
            x += addHtmlValue("權限", r.join("，"));
            if (((userinfo._id) != userid) && (cmeshrights == 0xFFFFFFFF || (((cmeshrights & 2) != 0) && (meshrights != 0xFFFFFFFF)))) buttons += 4;
            setDialogMode(2, "設備組用戶", buttons, p20viewuserEx, x, userid);
        }
        ...
        function p20viewuserEx(button, userid) {
            ...
            setDialogMode(2, "遠程網狀用戶", 3, p20viewuserEx2, format("確認刪除用戶{0}？", uname), userid);
        }
        ...
        function getFileSizeStr(size) { if (typeof size != 'number') { size = 0; } if (size == 1) return "1個字節"; return format('{0} bytes', size); }
