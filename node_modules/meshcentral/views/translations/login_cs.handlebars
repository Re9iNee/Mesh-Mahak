...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" class="arg_hide login">
    ...
    <script>
        ...
        function useEmailToken() {
            ...
            setDialogMode(1, "Zabezpečené přihlášení", 3, useEmailKeyEx, "Odeslat token na zaregistrovanou e-mailovou adresu?");
        }
        ...
        function useSMSToken() {
            ...
            setDialogMode(1, "Zabezpečené přihlášení", 3, useSMSTokenEx, "Send token to registed phone number?");
        }
