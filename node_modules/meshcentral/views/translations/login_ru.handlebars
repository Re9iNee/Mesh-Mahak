...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" class="arg_hide login">
                    ...
                    <td id="logincell">
                        ...
                        <div id="tokenpanel" style="display:none">
                            <form method="post" autocomplete="off">
                                ...
                                <table>
                                    <tbody><tr>
                                        <td align="right" width="100">Логин токен:</td>
                                        <td>
    ...
    <script>
        ...
        function startup() {
            ...
            var okmessages = ['', "If valid, reset mail sent.", "Письмо отправлено.", "Email verification required, check your mailbox and click the confirmation link.", "SMS sent."];
            var failmessages = ["Невозможно создать учетную запись.", "Достигнуто ограничение учетных записей.", "Существующий аккаунт с этим адресом email.", "Некорректный токен создания учетной записи.", "Имя пользователя уже существует.", "Пароль не принят, используйте другой.", "Некорректный email.", "Учетная запись не найдена.", "Некорректный токен, попробуйте еще.", "Не удалось отправить email.", "Учетная запись заблокирована.", "Отказано в доступе.", "Вход не выполнен, проверьте имя пользователя и пароль.", "Требуется смена пароля.", "IP адрес заблокирован, повторите попытку позже."];
            if (messageid > 0) {
                var msg = '';
        ...
        function useSMSToken() {
            ...
            setDialogMode(1, "Безопасный вход", 3, useSMSTokenEx, "Send token to registed phone number?");
        }
