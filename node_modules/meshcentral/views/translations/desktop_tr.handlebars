...
<body style="overflow:hidden;background-color:black">
    ...
    <script>
        ...
        var expire = '{{{expire}}}';
        if (expire != '') { QH('p11power', format("{0} itibarıyla sona eriyor", printTime(new Date(parseInt(expire))))) }
        ...
        */
        ...
        function deskSaveImage() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            var d = new Date(), n = "Masaüstü Bilgisayar" + '-' + d.getFullYear() + '-' + ('0' + (d.getMonth() + 1)).slice(-2) + '-' + ('0' + d.getDate()).slice(-2) + '-' + ('0' + d.getHours()).slice(-2) + '-' + ('0' + d.getMinutes()).slice(-2);
