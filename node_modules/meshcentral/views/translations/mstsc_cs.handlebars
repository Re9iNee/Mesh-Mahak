    ...
    <div id="main" class="container" style="position:absolute;top:0px;right:0;left:0;bottom:0px">
        <div class="middleContainer">
            ...
            <table class="signinform">
                ...
                <tr>
                    <td><label for="inputUsername" class="formLabel">Uživatelské jméno</label></td>
                    <td style="text-align:right"><input type="text" id="inputUsername" class="formControl" placeholder="Uživatelské jméno"></td>
                </tr>
                <tr>
                    <td><label for="inputPassword" class="formLabel">Heslo</label></td>
                    <td style="text-align:right"><input type="password" id="inputPassword" class="formControl" placeholder="Heslo"></td>
                </tr>
                <tr>
                    <td colspan="2"><button class="connectButton" onclick="return connect()">Připojit</button></td>
                </tr>
            </tbody></table>
        </div>
    </div>
