    ...
    <div id="main" class="container" style="position:absolute;top:0px;right:0;left:0;bottom:0px">
        <div class="middleContainer">
            ...
            <table class="signinform">
                ...
                <tr>
                    <td><label for="inputDomain" class="formLabel">Domaine</label></td>
                    <td style="text-align:right"><input type="text" id="inputDomain" class="formControl" placeholder="Domaine"></td>
                </tr>
                <tr>
                    <td><label for="inputUsername" class="formLabel">Nom d'utilisateur</label></td>
                    <td style="text-align:right"><input type="text" id="inputUsername" class="formControl" placeholder="Nom d'utilisateur"></td>
                </tr>
                <tr>
                    <td><label for="inputPassword" class="formLabel">Mot de passe</label></td>
                    <td style="text-align:right"><input type="password" id="inputPassword" class="formControl" placeholder="Mot de passe"></td>
                </tr>
                <tr>
                    <td colspan="2"><button class="connectButton" onclick="return connect()">Se connecter</button></td>
                </tr>
            </tbody></table>
        </div>
    </div>
