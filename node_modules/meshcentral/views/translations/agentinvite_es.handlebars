...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
        ...
        <div id="column_l" style="max-height:calc(100vh - 135px);overflow-y:auto">
            ...
            <div>
                ...
                <div id="wintab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win64url">Descargue el software aquí</a>ejecútelo y presione "Instalar" o "Conectar".</p>
                ...
                <div id="wintab32" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win32url">Descargue el software aquí</a>ejecútelo y presione "Instalar" o "Conectar".</p>
                    <div style="text-align:center">
                        <img class="winagent-img" src="images/winagent.png">
                    </div>
                </div>
                ...
                <div id="linuxtab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Linux</h3>
                    <p>Para instalar, corte y pegue el siguiente comando en un terminal como root.</p>
                    ...
                    <p>Para desinstalar, corte y pegue el siguiente comando como root.</p>
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Apple™ MacOS</h3>
                    <p><a id="macosurl">Descargue el instalador aquí</a>, haga click derecho o presione "Ctrl" y de click en el archivo. Despues seleecione  "Abrir" y siga las instrucciones.</p>
                    <div style="text-align:center">
    ...
    <script>
        ...
        if (groupName != '') {
            QH('groupname', format("Instalación de Agente Remoto de {0}", escapeHtml(groupName)));
