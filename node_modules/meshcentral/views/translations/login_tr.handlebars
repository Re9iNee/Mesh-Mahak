...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" class="arg_hide login">
                    ...
                    <td id="logincell">
                        <div id="loginpanel" style="display:none">
                            <form method="post">
                                ...
                                <div id="authStrategies" style="display:none">
                                    ...
                                    <a id="auth-reddit" href="auth-reddit" style="display:none"><img src="images/login/reddit32.png" loading="lazy" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Reddit kullanarak oturum açın"></a>
                        ...
                        <div id="createpanel" style="display:none;position:relative">
                            <form method="post">
                                ...
                                <table>
                                    ...
                                    <tr id="newAccountPass" title="Hesap oluşturma jetonunu girin">
                                        <td id="nuToken" align="right">Oluşturma Simgesi:</td>
                        ...
                        <div id="tokenpanel" style="display:none">
                            <form method="post" autocomplete="off">
                                ...
                                <table>
                                    <tbody><tr>
                                        <td align="right" width="100">Giriş jetonu:</td>
                                        <td>
    ...
    <script>
        ...
        function startup() {
            ...
            var failmessages = ["Hesap oluşturulamıyor.", "Hesap sınırına ulaşıldı.", "Bu e-posta adresine sahip mevcut hesap.", "Geçersiz hesap oluşturma belirteci.", "Kullanıcı adı zaten var.", "Şifre reddedildi, farklı bir tane kullanın.", "Geçersiz e-posta.", "Hesap bulunamadı.", "Geçersiz jeton, tekrar deneyin.", "E-posta gönderilemiyor.", "Hesap kilitlendi.", "Erişim reddedildi.", "Giriş başarısız oldu, kullanıcı adı ve şifreyi kontrol edin.", "Şifre değişikliği istendi.", "IP adresi engellendi, daha sonra tekrar deneyin."];
            if (messageid > 0) {
                var msg = '';
