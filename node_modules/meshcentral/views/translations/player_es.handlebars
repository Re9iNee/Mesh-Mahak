...
<body style="overflow:hidden;background-color:black">
    <div id="p11" class="noselect" style="overflow:hidden">
        <div id="deskarea0">
            <div id="deskarea1" class="areaHead">
                ...
                <div>
                    <input id="OpenFileButton" type="button" value="Abrir archivo..." onclick="openfile()">
            ...
            <div id="deskarea4" class="areaFoot">
                ...
                <div>
                    &nbsp;
                    <input id="PlayButton" type="button" value="Iniciar" disabled="disabled" onclick="play()">
                    ...
                    <select id="PlaySpeed" onchange="this.blur();">
                        ...
                        <option value="0.5">Velocidad 2x</option>
                        <option value="0.25">Velocidad 4x</option>
                        <option value="0.1">Velocidad 10x</option>
                    </select>
    ...
    <script>
        ...
        function processFirstBlock(type, flags, time, data) {
            ...
            if (recFileEndTime != 0) { var secs = Math.floor((recFileEndTime - time) / 1000); x += addInfo("Duración", format("{0} second{1}", secs, (secs > 1) ? 's' : '')); }
            x += addInfo("Usuario", recFileMetadata.username);
            ...
            if (recFileMetadata.protocol) {
                ...
                else if (p == 2) { p = "Escritorio MeshCentral"; }
                else if (p == 100) { p = "Intel&reg; AMT WSMAN"; }
                else if (p == 101) { p = "Intel & reg; Redirección AMT"; }
                else if (p == 200) { p = "Intel&reg; AMT KVM"; }
                x += addInfoNoEsc("Protocolo", p);
            }
            if (recFileMetadata.bpp == 1) { x += addInfoNoEsc("Calidad del color", "256 colores"); }
            if (recFileMetadata.bpp == 2) { x += addInfoNoEsc("Calidad del color", "65536 colores"); }
        ...
        function cleanup() {
            ...
            QV('metadatadiv', true);
            QH('metadatadiv', '<span style=\"font-family:Arial,Helvetica Neue,Helvetica,sans-serif;font-size:28px\">MeshCentral Session Player</span><br /><br /><span style=color:gray>' + "Arrastre y suelte un archivo .mcrec o haga clic en \"Abrir archivo...\"" + '</span>');
            QV('DeskParent', true);
            QV('TermParent', false);
        }
