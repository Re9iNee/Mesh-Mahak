<!DOCTYPE html><html lang="tr" style="height:100%"><head>
    ...
    <body style="font-family:Arial,Helvetica,sans-serif">
        ...
        <div id="xbottom" style="position:absolute;left:0;right:0;bottom:0px;height:30px;background-color:#036">
            ...
            <input type="button" id="sendButton" value="Gönder" style="position:absolute;right:110px;width:100px;top:4px;" onclick="xsend(event)">
            <input type="button" id="clearButton" value="Açık" style="position:absolute;right:5px;width:100px;top:4px;" onclick="displayClear()">
        </div>
        ...
        <script type="text/javascript" onunload="onUnLoad()">
            ...
            function fileSelect() {
                ...
                if (x.files.length > 10) {
                    displayControl("Aynı anda 10 dosya yükleme sınırı.");
                } else {
            ...
            function startFileUpload(file) {
                ...
                chatTextSession += ((new Date()).toLocaleTimeString() + ' - ' + "Yükle" + '> ' + file.name + ' (' + file.size + ' ' + "bayt" + ')\r\n');
