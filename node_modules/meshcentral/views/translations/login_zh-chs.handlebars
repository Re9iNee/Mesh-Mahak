...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" class="arg_hide login">
                            ...
                            <form method="post">
                                ...
                                <table id="checkCheckOperations" style="width:100%;display:none">
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input id="changeEmailButton" type="button" value="更改电子邮件地址" onclick="changeEmailAddress()">
    ...
    <script>
        ...
        function startup() {
            ...
            var okmessages = ['', "如果有效，请重置已发送的邮件。", "郵件已發送。", "需要通过电子邮件验证，请检查您的邮箱，然后单击确认链接。", "短信已发送。"];
        ...
        function useSMSToken() {
            ...
            setDialogMode(1, "安全登錄", 3, useSMSTokenEx, "将令牌发送到注册电话号码？");
        }
