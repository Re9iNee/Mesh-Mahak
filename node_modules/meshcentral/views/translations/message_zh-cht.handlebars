...
<body>
    ...
    <script>
        ...
        switch (msgid) {
            ...
            case 2: { msg = "錯誤：無效的用戶名“ {0} ”。"; break; }
            case 3: { msg = format("錯誤：用戶“ {1} ”的無效電子郵件“ {0} ”。", arg1, arg2); break; }
            case 4: { msg = format("用戶“ {1} ”的電子郵件“ {0} ”已通過驗證。", arg1, arg2); break; }
            case 5: { msg = format("電子郵件“ {0} ”已在其他帳戶上使用。更改電子郵件地址，然後重試。", arg1); break; }
            case 6: { msg = format("用戶帳戶{1}的已驗證電子郵件{0}。", '<b>' + arg1 + '</b>', '<b>' + arg2 + '</b>'); break; }
            case 7: { msg = format("未驗證用戶“ {1} ”的電子郵件“ {0} ”。", arg1, arg2); break; }
            case 8: {
                msg = '<div>' + format("帳戶{0}的密碼已重置為：", '<b>' + arg1 + '</b>') + '</div><div style=padding:14px;font-size:18px><b>' + arg2 + '</b></div>';
                msg += "登錄並進入“我的帳戶”標籤以更新密碼。";
                break;
            }
            case 9: { msg = "錯誤：無效的帳戶檢查。"; break; }
            case 10: { msg = "錯誤：無效的帳戶檢查，驗證網址僅在30分鐘內有效。"; break; }
        }
        QH('mainMessage', msg + ' <a href="' + domainurl + '">' + "進入登錄頁面" + '</a>.');
