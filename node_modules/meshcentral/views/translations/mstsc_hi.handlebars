    ...
    <div id="main" class="container" style="position:absolute;top:0px;right:0;left:0;bottom:0px">
        <div class="middleContainer">
            ...
            <table class="signinform">
                ...
                <tr>
                    <td><label for="inputUsername" class="formLabel">उपयोगकर्ता नाम</label></td>
                    <td style="text-align:right"><input type="text" id="inputUsername" class="formControl" placeholder="उपयोगकर्ता नाम"></td>
                </tr>
                <tr>
                    <td><label for="inputPassword" class="formLabel">कुंजिका</label></td>
                    <td style="text-align:right"><input type="password" id="inputPassword" class="formControl" placeholder="कुंजिका"></td>
                </tr>
                <tr>
                    <td colspan="2"><button class="connectButton" onclick="return connect()">जुडिये</button></td>
                </tr>
            </tbody></table>
        </div>
    </div>
