...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
    <div id="container">
        ...
        <div id="column_l" style="max-height:calc(100vh - 135px);overflow-y:auto">
            ...
            <div style="text-align:center;font-size:20px;font-family:Arial;color:#999">Esta página não existe</div>
            <div style="text-align:center;padding-top:20px;font-size:20px;font-family:Arial;color:#999"><a href="/" style="text-decoration:none"><b>Ir para o site principal</b></a></div>
        </div>
        <div id="footer">
