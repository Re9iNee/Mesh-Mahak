    ...
    <div id="main" class="container" style="position:absolute;top:0px;right:0;left:0;bottom:0px">
        <div class="middleContainer">
            ...
            <table class="signinform">
                ...
                <tr>
                    <td><label for="inputUsername" class="formLabel">Имя пользователя</label></td>
                    <td style="text-align:right"><input type="text" id="inputUsername" class="formControl" placeholder="Имя пользователя"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2"><button class="connectButton" onclick="return connect()">Подключиться</button></td>
                </tr>
            </tbody></table>
        </div>
    </div>
