...
<body style="overflow:hidden;background-color:black">
    <div id="p11" class="noselect" style="overflow:hidden">
        <div id="deskarea0">
            <div id="deskarea1" class="areaHead">
                ...
                <div>
                    <input id="OpenFileButton" type="button" value="Ouvrir le fichier..." onclick="openfile()">
    ...
    <script>
        ...
        function processFirstBlock(type, flags, time, data) {
            ...
            if (recFileMetadata.bpp == 1) { x += addInfoNoEsc("Nombre de couleurs", "256 couleurs"); }
            if (recFileMetadata.bpp == 2) { x += addInfoNoEsc("Nombre de couleurs", "65536 couleurs"); }
