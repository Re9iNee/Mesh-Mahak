    ...
    <div id="main" class="container" style="position:absolute;top:0px;right:0;left:0;bottom:0px">
        <div class="middleContainer">
            ...
            <table class="signinform">
                ...
                <tr>
                    <td><label for="inputUsername" class="formLabel">Nome de usuário</label></td>
                    <td style="text-align:right"><input type="text" id="inputUsername" class="formControl" placeholder="Nome de usuário"></td>
                </tr>
                <tr>
                    <td><label for="inputPassword" class="formLabel">Senha</label></td>
                    <td style="text-align:right"><input type="password" id="inputPassword" class="formControl" placeholder="Senha"></td>
                </tr>
                <tr>
