...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
    <div id="container">
        ...
        <div id="column_l" style="max-height:calc(100vh - 135px);overflow-y:auto">
            <h1><span id="groupname">Entfernte Agenten-Installation</span></h1>
            <p>
            ...
            <div>
                ...
                <div id="linuxtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p>Zum Deinstallieren, kopieren Sie den folgenden Befehl und führen Sie ihn aus root aus.</p>
    ...
    <script>
        ...
        if (groupName != '') {
            QH('groupname', format("Remote Agent Installation für {0}", escapeHtml(groupName)));
            document.title = format("{0} - Agenteninstallation", groupName);
        } else {
