...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
    <div id="container">
        ...
        <div id="column_l" style="max-height:calc(100vh - 135px);overflow-y:auto">
            ...
            <div style="text-align:center;font-size:20px;font-family:Arial;color:#999">Bu sayfa mevcut değil</div>
            <div style="text-align:center;padding-top:20px;font-size:20px;font-family:Arial;color:#999"><a href="/" style="text-decoration:none"><b>Ana siteye git</b></a></div>
        </div>
        <div id="footer">
            <table cellpadding="0" cellspacing="10" style="width: 100%">
                <tbody><tr>
                    <td style="text-align:left"></td>
                    <td style="text-align:right"><a href="/">Geri</a></td>
                </tr>
            </tbody></table>
        </div>
    </div>
