<!DOCTYPE html><html lang="ko" style="height:100%"><head>
    ...
    <body style="font-family:Arial,Helvetica,sans-serif">
        <div id="xtop" style="position:absolute;left:0;right:0;top:0;height:38px;background-color:#036;color:#c8c8c8;box-shadow:3px 3px 10px gray">
            ...
            <div style="padding-top:9px;padding-left:6px;font-size:20px;display:inline-block"><b><span id="xtitle">메시 메신저</span></b></div>
        </div>
        ...
        <div id="xbottom" style="position:absolute;left:0;right:0;bottom:0px;height:30px;background-color:#036">
            ...
            <input type="button" id="sendButton" value="전송" style="position:absolute;right:110px;width:100px;top:4px;" onclick="xsend(event)">
            <input type="button" id="clearButton" value="지우기" style="position:absolute;right:5px;width:100px;top:4px;" onclick="displayClear()">
        </div>
        ...
        <script type="text/javascript" onunload="onUnLoad()">
            ...
            function displayRemote(msg) {
                ...
                if (Notification && (windowFocus == false) && (Notification.permission == 'granted')) {
                    if (notification != null) { notification.close(); notification = null; }
                    if (args.title) {
                        notification = new Notification("메시 메신저" + ' - ' + args.title, { body: msg });
                    } else {
                        notification = new Notification("메시 메신저", { body: msg });
                    }
                }
            }
