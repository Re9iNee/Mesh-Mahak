...
<body>
    ...
    <script>
        ...
        switch (msgid) {
            ...
            case 2: { msg = "FOUT: Ongeldige gebruikersnaam \"{0}\"."; break; }
            ...
            case 6: { msg = format("Geverifieerd e-mailadres {0} voor gebruikersaccount {1}.", '<b>' + arg1 + '</b>', '<b>' + arg2 + '</b>'); break; }
            case 7: { msg = format("E-mail \"{0}\" voor gebruiker \"{1}\" niet geverifieerd.", arg1, arg2); break; }
            case 8: {
                msg = '<div>' + format("Wachtwoord voor account {0} is gereset naar:", '<b>' + arg1 + '</b>') + '</div><div style=padding:14px;font-size:18px><b>' + arg2 + '</b></div>';
        ...
        QH('mainMessage', msg + ' <a href="' + domainurl + '">' + "Ga naar de inlogpagina" + '</a>.');
