...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" class="arg_hide login">
                        ...
                        <div id="loginpanel" style="display:none">
                            <form method="post">
                                ...
                                <div id="authStrategies" style="display:none">
                                    ...
                                    <a id="auth-reddit" href="auth-reddit" style="display:none"><img src="images/login/reddit32.png" loading="lazy" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Kirjautuminen Redditin avulla"></a>
    ...
    <script>
        ...
        function useEmailToken() {
            ...
            setDialogMode(1, "Suojattu kirjautuminen", 3, useEmailKeyEx, "Send token to registed email address?");
        }
        ...
        function useSMSToken() {
            ...
            setDialogMode(1, "Suojattu kirjautuminen", 3, useSMSTokenEx, "Send token to registed phone number?");
        }
