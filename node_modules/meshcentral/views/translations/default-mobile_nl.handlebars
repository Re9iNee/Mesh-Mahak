...
<body onload="if (typeof(startup) !== 'undefined') startup();" style="overflow-y:hidden;margin:0;padding:0;border:0;color:black;font-size:13px;font-family:\'Trebuchet MS\', Arial, Helvetica, sans-serif">
                        ...
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:25px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div style="margin-left:3px">
                                    ...
                                    <input type="button" id="connectbutton1h" value="HW verbinden" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled">
                                    <input type="button" id="disconnectbutton1" value="Verbreken" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false">
                        ...
                        <div id="deskarea3" style="position:absolute;top:25px;width:100%;height:calc(100% - 50px)">
                            <div id="deskarea3x" style="background:black;text-align:center;height:100%;position:relative">
                                ...
                                <div id="DeskTools" style="position:absolute;width:400px;height:100%;background-color:gray;top:0;right:0;border-left:2px solid lightgray;display:none">
                                    <a id="DeskToolsRefreshButton" style="float:right;padding:3px;cursor:pointer" onclick="refreshDeskTools()">Verversen</a>
                                    <div id="DeskToolsBar" style="position:absolute;padding:3px;border-radius: 3px 3px 0px 0px;top:5px;left:4px;bottom:26px;background-color:lightgray;cursor:pointer">Processen</div>
                                    <div style="position:absolute;top:26px;left:4px;right:4px;bottom:4px;background-color:lightgray;text-align:left">
                                        <div style="border-bottom:1px solid darkgray;padding:3px"><a style="width:50px;padding-right:5px;float:left;cursor:pointer" onclick="sortProcess(0)">PID</a><a style="cursor:pointer" onclick="sortProcess(1)">Naam</a></div>
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:25px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    ...
                                    <input type="button" id="DeskSpecialKeys" value="Sleutels" onkeypress="return false" onkeydown="return false" onclick="sendSpecialKeys()">
                                    <input type="button" id="DeskSoftKeys" value="Toetsenbord" onkeypress="return false" onkeydown="return false" onclick="toggleSoftKeys(1)">
                                    <input type="button" id="DeskScreens" value="Schermen" onkeypress="return false" onkeydown="return false" onclick="deskSelectScreens()" style="display:none">
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    ...
                    <div style="margin:3px 0 3px 0">
                        ...
                        <div style="height:20px">Kwaliteit</div>
                    </div>
                    <div style="margin:3px 0 3px 0">
                        ...
                        <div style="height:20px">Schalen</div>
                    </div>
                    <div style="margin:3px 0 3px 0">
                        ...
                        <div style="height:20px">Beoordeel</div>
                    </div>
                </div>
                <div id="d7amtkvm">
                    ...
                    <div style="height:60px">
                        <div style="float:right;border:1px solid #666;width:200px;height:60px;overflow-y:scroll;background-color:white">
                            <label><input type="checkbox" id="d7showfocus">Toon focus tool</label><br>
                            <label><input type="checkbox" id="d7showcursor">Lokale muiscursor weergeven</label><br>
                        </div>
                        <div>Anders</div>
                    </div>
                </div>
    ...
    <script>
            ...
            for (var i in nodes) {
                ...
                if (sort == 0) {
                    ...
                    if (((meshes[nodes[i].meshid]?nodes[i].meshid:'*') != current)) {
                        deviceHeaderSet();
                        var extra = '';
                        if ((meshes[nodes[i].meshid] != null) && (meshes[nodes[i].meshid].mtype == 1)) { extra = '<span style=color:lightgray>' + ", Intel&reg; AMT alleen" + '</span>'; }
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype == 2) { r += '<div style=padding:10px><i>' + "Geen apparaten in deze groep"; }
                        r += '.</i></div></div>';
                        current = mesh._id;
                        count++;
                    }
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if (node.intelamt != null) {
                    ...
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("Onbekende staat") + '</i>, v' + EscapeHtml(node.intelamt.ver); } else
                    ...
                    if (node.intelamt.state == 2) {
                        if (node.intelamt.user == null || node.intelamt.user == '') {
                            if ((meshrights & 4) != 0) {
                                str += ', <i style=color:#FF0000;cursor:pointer onclick=editDeviceAmtSettings("' + node._id + '")>' + nobreak("Geen referenties") + '</i>';
                            } else {
                ...
                if ((meshrights & 76) != 0) { x += '<input type=button value=\"' + "Acties" + '\" onclick=deviceActionFunction() />'; }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype == 2) && (currentNode.agent.caps & 4))) { menus.push({ n: "Bestanden", f: 'setupDeviceMenu(2)' }); }
        ...
        function deviceActionFunction() {
            ...
            if ((meshrights & 8) != 0) { y += '<option value=4>' + "Slaapstand" + '</option><option value=3>' + "Herstarten" + '</option><option value=2>' + "Uitzetten" + '</option>'; } // Remote control permission
            y += '</select>';
        ...
        */
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            if ((hardware.windows && hardware.windows.osinfo) || node.osdesc) {
                ...
                if (x != '') { sections.push({ name: "Besturingssysteem", html: x, img: 'software32.png' }); }
            }
            ...
            if (hardware.identifiers) {
                ...
                if (x != '') { sections.push({ name: "Moederbord", html: x, img: 'motherboard32.png' }); }
            }
            ...
            if (hardware.windows) {
                if (hardware.windows.memory) {
                    ...
                    if (x != '') { sections.push({ name: "Geheugen", html: x, img: 'ram32.png' }); }
                }
            }
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                if (x != '') { sections.push({ name: "Opslag", html: x, img: 'storage32.png' }); }
            }
