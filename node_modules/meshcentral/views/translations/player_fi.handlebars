...
<body style="overflow:hidden;background-color:black">
    <div id="p11" class="noselect" style="overflow:hidden">
        <div id="deskarea0">
            <div id="deskarea1" class="areaHead">
                ...
                <div>
                    <input id="OpenFileButton" type="button" value="Avaa tiedosto..." onclick="openfile()">
    ...
    <script>
        ...
        function processFirstBlock(type, flags, time, data) {
            ...
            if (recFileMetadata.ipaddr1 && recFileMetadata.ipaddr2) { x += addInfo("Osoitteet", format("{0} to {1}", recFileMetadata.ipaddr1, recFileMetadata.ipaddr2)); }
            ...
            if (recFileMetadata.bpp == 1) { x += addInfoNoEsc("Värin laatu", "256 väriä"); }
            if (recFileMetadata.bpp == 2) { x += addInfoNoEsc("Värin laatu", "65536 väriä"); }
