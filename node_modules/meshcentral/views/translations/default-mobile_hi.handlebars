...
<body onload="if (typeof(startup) !== 'undefined') startup();" style="overflow-y:hidden;margin:0;padding:0;border:0;color:black;font-size:13px;font-family:\'Trebuchet MS\', Arial, Helvetica, sans-serif">
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:30px;left:0;right:0;bottom:0px;background-color:#aaa">
                        <div style="margin:4px">
                            ...
                            <input id="SearchInput" type="text" placeholder="फ़िल्टर" onchange="onDeviceSearchChanged(event)" onkeyup="onDeviceSearchChanged(event)" autocomplete="off">&nbsp;
                    ...
                    <div id="p10desktop" style="overflow:hidden;position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:25px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div style="margin-left:3px">
                                    <input type="button" id="connectbutton1" value="जुडिये" onclick="connectDesktop(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled">
                                    <input type="button" id="connectbutton1h" value="एचडब्ल्यू कनेक्ट" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled">
                                    <input type="button" id="disconnectbutton1" value="डिस्कनेक्ट" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false">
                                    <span id="deskstatus">डिस्कनेक्ट किया गया</span>
                                </div>
                            </div>
                        </div>
                        <div id="deskarea3" style="position:absolute;top:25px;width:100%;height:calc(100% - 50px)">
                            <div id="deskarea3x" style="background:black;text-align:center;height:100%;position:relative">
                                ...
                                <div id="DeskTools" style="position:absolute;width:400px;height:100%;background-color:gray;top:0;right:0;border-left:2px solid lightgray;display:none">
                                    <a id="DeskToolsRefreshButton" style="float:right;padding:3px;cursor:pointer" onclick="refreshDeskTools()">ताज़ा करना</a>
                                    <div id="DeskToolsBar" style="position:absolute;padding:3px;border-radius: 3px 3px 0px 0px;top:5px;left:4px;bottom:26px;background-color:lightgray;cursor:pointer">प्रक्रियाओं</div>
                                    <div style="position:absolute;top:26px;left:4px;right:4px;bottom:4px;background-color:lightgray;text-align:left">
                                        <div style="border-bottom:1px solid darkgray;padding:3px"><a style="width:50px;padding-right:5px;float:left;cursor:pointer" onclick="sortProcess(0)">पीआईडी</a><a style="cursor:pointer" onclick="sortProcess(1)">नाम</a></div>
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:25px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    <input id="deskActionsBtn" type="button" style="margin-left:3px" onkeypress="return false" onkeydown="return false" value="क्रिया" onclick="deviceActionFunction()">
                                    <input type="button" value="समायोजन" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()">
                                    <input type="button" onkeypress="return false" onkeydown="return false" value="पावर एक्शन ..." onclick="showPowerActionDlg()" style="display:none">
                                    <input type="button" id="DeskSpecialKeys" value="Keys" onkeypress="return false" onkeydown="return false" onclick="sendSpecialKeys()">
                                    <input type="button" id="DeskSoftKeys" value="कीबोर्ड" onkeypress="return false" onkeydown="return false" onclick="toggleSoftKeys(1)">
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    ...
                    <div style="margin:3px 0 3px 0">
                        ...
                        <div style="height:20px">गुणवत्ता</div>
                    </div>
                    <div style="margin:3px 0 3px 0">
                        ...
                        <div style="height:20px">स्केलिंग</div>
                    </div>
                    <div style="margin:3px 0 3px 0">
                        ...
                        <div style="height:20px">मूल्यांकन करें</div>
                    </div>
                </div>
                <div id="d7amtkvm">
                    ...
                    <div style="height:60px">
                        <div style="float:right;border:1px solid #666;width:200px;height:60px;overflow-y:scroll;background-color:white">
                            <label><input type="checkbox" id="d7showfocus">फोकस टूल दिखाएं</label><br>
                            <label><input type="checkbox" id="d7showcursor">स्थानीय माउस कर्सर दिखाएँ</label><br>
                        </div>
                        <div>अन्य</div>
                    </div>
                </div>
    ...
    <script>
        ...
        function updateFiles() {
            ...
            var html1 = '', html2 = '', displayPath = '<a style=cursor:pointer onclick=p5folderup(0)>' + "जड़" + '</a>', fullPath = 'Root', publicPath, filetreex = filetree, folderdepth = 1;
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype == 2) { r += '<div style=padding:10px><i>' + "इस समूह में कोई उपकरण नहीं है"; }
                        r += '.</i></div></div>';
                        current = mesh._id;
                        count++;
                    }
        ...
        var powerStateStrings = ['', "संचालित", "सोया हुआ", "सोया हुआ", "गहरी नींद", "सुप्तावस्था", "शीतल-ऑफ", "वर्तमान"];
        ...
        function NodeStateStr(node) {
            ...
            if (node.conn) {
                if ((node.conn & 1) != 0) { states.push('<span>' + "एजेंट" + '</span>'); }
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if ((node.agent != null) && (node.agent.id != null) && (node.agent.ver != null)) {
                    ...
                    x += addDeviceAttribute("एजेंट", str);
                }
                ...
                if (node.intelamt != null) {
                    ...
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("अज्ञात राज्य") + '</i>, v' + EscapeHtml(node.intelamt.ver); } else
                    ...
                    if (node.intelamt.tls == 1) { str += ', <span>' + "टीएलएस" + '</span>'; }
                    if (node.intelamt.state == 2) {
                        if (node.intelamt.user == null || node.intelamt.user == '') {
                            if ((meshrights & 4) != 0) {
                                str += ', <i style=color:#FF0000;cursor:pointer onclick=editDeviceAmtSettings("' + node._id + '")>' + nobreak("कोई साख नहीं") + '</i>';
                            } else {
                ...
                if (connectivity && connectivity > 1) {
                    var cstate = [];
                    if ((node.conn & 1) != 0) cstate.push('<span>' + "एजेंट" + '</span>');
                ...
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("टैग", '<span onclick=showEditNodeValueDialog(3) style=cursor:pointer>' + groupingTags + '</span>');
                } else {
                    x += addDeviceAttribute("टैग", groupingTags);
                }

                x += '</table><br />';
                // Show action button, only show if we have permissions 4, 8, 64
                if ((meshrights & 76) != 0) { x += '<input type=button value=\"' + "क्रिया" + '\" onclick=deviceActionFunction() />'; }
                ...
                if ((connectivity & 1) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += '<span style=font-size:10px>' + "मेष एजेंट" + '</span>'; }
                if ((connectivity & 2) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += '<span style=font-size:10px>' + "Intel&reg; AMT जुड़ा हुआ है" + '</span>'; }
                else if ((connectivity & 4) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += '<span style=font-size:10px>' + "Intel&reg; AMT का पता चला" + '</span>'; }
                if ((connectivity & 16) != 0) { if (powerstate.length > 0) { powerstate += '<br/>'; } powerstate += '<span style=font-size:12px>' + "MQTT चैनल जुड़ा" + '</span>'; }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype == 2) && (currentNode.agent.caps & 4))) { menus.push({ n: "फ़ाइलें", f: 'setupDeviceMenu(2)' }); }
            if ((currentDevicePanel != 3) && (currentNode != null)) { menus.push({ n: "विवरण", f: 'setupDeviceMenu(3)' }); }
        ...
        function deviceActionFunction() {
            ...
            if ((meshrights & 64) != 0) { y += '<option value=100>' + "उठो" + '</option>'; } // Wake-up permission
            if ((meshrights & 8) != 0) { y += '<option value=4>' + "नींद" + '</option><option value=3>' + "रीसेट" + '</option><option value=2>' + "बिजली बंद" + '</option>'; } // Remote control permission
            y += '</select>';
        ...
        function editDeviceAmtSettings(nodeid, func) {
            ...
            x += addHtmlValue("सुरक्षा", '<select id=dp10tls style=width:176px><option value=0>' + "कोई टीएलएस सुरक्षा नहीं" + '</option><option value=1>' + "TLS सुरक्षा की आवश्यकता है" + '</option></select>');
        ...
        */
        ...
        function p13updateFiles(checkedNames) {
            var html1 = '', html2 = '', displayPath = '<a style=cursor:pointer onclick=p13folderup(0)>' + "जड़" + '</a>', fullPath = 'Root';
        ...
        */
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            if ((hardware.windows && hardware.windows.osinfo) || node.osdesc) {
                ...
                if (x != '') { sections.push({ name: "ऑपरेटिंग सिस्टम", html: x, img: 'software32.png' }); }
            }
            ...
            if (node.agent) {
                ...
                if (x != '') { sections.push({ name: "मेष एजेंट", html: x, img: 'meshagent32.png' }); }
            }
            ...
            if (node.intelamt != null) {
                ...
                if (x != '') { sections.push({ name: "Intel&reg; सक्रिय प्रबंधन प्रौद्योगिकी (Intel&reg; AMT)", html: x, img: 'amt32.png' }); }
            }
            ...
            if (hardware.identifiers) {
                ...
                if (x != '') { sections.push({ name: "मदरबोर्ड", html: x, img: 'motherboard32.png' }); }
            }
            ...
            if (hardware.windows) {
                if (hardware.windows.memory) {
                    ...
                    if (x != '') { sections.push({ name: "स्मृति", html: x, img: 'ram32.png' }); }
                }
            }
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                if (x != '') { sections.push({ name: "भंडारण", html: x, img: 'storage32.png' }); }
            }
        ...
        function p20updateMesh() {
            ...
            if (currentMeshLinks && ((currentMeshLinks.rights & 2) != 0)) { x += '<div style=margin-bottom:6px><a onclick=p20showAddMeshUserDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "उपयोगकर्ता जोड़ें" + '</a></div>'; }
