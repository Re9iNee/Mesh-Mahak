    ...
    <div id="main" class="container" style="position:absolute;top:0px;right:0;left:0;bottom:0px">
        <div class="middleContainer">
            ...
            <table class="signinform">
                ...
                <tr>
                    <td><label for="inputDomain" class="formLabel">Domein</label></td>
                    <td style="text-align:right"><input type="text" id="inputDomain" class="formControl" placeholder="Domein"></td>
                </tr>
                <tr>
                    <td><label for="inputUsername" class="formLabel">Gebruikersnaam</label></td>
                    <td style="text-align:right"><input type="text" id="inputUsername" class="formControl" placeholder="Gebruikersnaam"></td>
                </tr>
                <tr>
                    <td><label for="inputPassword" class="formLabel">Wachtwoord</label></td>
                    <td style="text-align:right"><input type="password" id="inputPassword" class="formControl" placeholder="Wachtwoord"></td>
                </tr>
                <tr>
                    <td colspan="2"><button class="connectButton" onclick="return connect()">Verbinden</button></td>
                </tr>
            </tbody></table>
        </div>
    </div>
