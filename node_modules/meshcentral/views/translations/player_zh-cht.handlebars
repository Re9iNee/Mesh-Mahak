...
<body style="overflow:hidden;background-color:black">
    <div id="p11" class="noselect" style="overflow:hidden">
        <div id="deskarea0">
            <div id="deskarea1" class="areaHead">
                ...
                <div>
                    <input id="OpenFileButton" type="button" value="打開文件..." onclick="openfile()">
            ...
            <div id="deskarea4" class="areaFoot">
                ...
                <div>
                    &nbsp;
                    <input id="PlayButton" type="button" value="玩" disabled="disabled" onclick="play()">
                    <input id="PauseButton" type="button" value="暫停" disabled="disabled" onclick="pause()">
                    <input id="RestartButton" type="button" value="重新開始" disabled="disabled" onclick="restart()">
    ...
    <script>
        ...
        function processFirstBlock(type, flags, time, data) {
            ...
            x += addInfo("用戶身份", recFileMetadata.userid);
            ...
            if (recFileMetadata.devicename) { x += addInfo("設備名稱", recFileMetadata.devicename); }
            ...
            if (recFileMetadata.protocol) {
                ...
                else if (p == 100) { p = "英特爾&reg;AMT WSMAN"; }
                else if (p == 101) { p = "英特爾&reg;AMT重定向"; }
                else if (p == 200) { p = "英特爾&reg;AMT KVM"; }
                x += addInfoNoEsc("協議", p);
            }
            if (recFileMetadata.bpp == 1) { x += addInfoNoEsc("色彩品質", "256色"); }
            if (recFileMetadata.bpp == 2) { x += addInfoNoEsc("色彩品質", "65536色"); }
        ...
        function cleanup() {
            ...
            QV('metadatadiv', true);
            QH('metadatadiv', '<span style=\"font-family:Arial,Helvetica Neue,Helvetica,sans-serif;font-size:28px\">MeshCentral Session Player</span><br /><br /><span style=color:gray>' + "拖放.mcrec文件或單擊 “打開文件...”" + '</span>');
            QV('DeskParent', true);
            QV('TermParent', false);
        }
        ...
        function openfile() {
            ...
            setDialogMode(2, "打開文件...", 3, openfileEx, x);
