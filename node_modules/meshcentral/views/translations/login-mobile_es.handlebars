                            ...
                            <div id="loginpanel" style="background-color:#979797;border-radius:16px;width:260px;padding:16px;text-align:center;clear:both;display:none">
                                <form method="post">
                                    ...
                                    <div id="newAccountDiv" style="display:none;padding:2px">
                                        No tienes una cuenta? <a onclick="xgo(2)" style="cursor:pointer">Crea uno</a>.
                                    </div>
                                    ...
                                    <form method="post">
                                        ...
                                        <table>
                                            <tbody><tr id="nuUserRow">
                                                <td align="right" width="100">Usuario:</td>
                                            ...
                                            <tr id="newAccountPass" title="Ingrese el token de creación de cuenta">
                                                <td align="right">Creación de Token:</td>
                                        ...
                                        <hr><a onclick="xgo(1)" style="cursor:pointer">Regresar al Inicio de Sesion</a>
