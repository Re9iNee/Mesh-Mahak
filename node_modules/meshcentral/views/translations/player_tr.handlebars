...
<body style="overflow:hidden;background-color:black">
    <div id="p11" class="noselect" style="overflow:hidden">
        <div id="deskarea0">
            <div id="deskarea1" class="areaHead">
                ...
                <div>
                    <input id="OpenFileButton" type="button" value="Açık dosya..." onclick="openfile()">
    ...
    <script>
        ...
        function processFirstBlock(type, flags, time, data) {
            ...
            if (recFileMetadata.ipaddr1 && recFileMetadata.ipaddr2) { x += addInfo("Adresler", format("{0} - {1}", recFileMetadata.ipaddr1, recFileMetadata.ipaddr2)); }
            if (recFileMetadata.devicename) { x += addInfo("Cihaz adı", recFileMetadata.devicename); }
            x += addInfo("Düğüm Kimliği", recFileMetadata.nodeid);
            ...
            if (recFileMetadata.bpp == 1) { x += addInfoNoEsc("Renk kalitesi", "256 renk"); }
            if (recFileMetadata.bpp == 2) { x += addInfoNoEsc("Renk kalitesi", "65536 renk"); }
