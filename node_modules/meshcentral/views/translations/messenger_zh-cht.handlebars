    ...
    <body style="font-family:Arial,Helvetica,sans-serif">
        <div id="xtop" style="position:absolute;left:0;right:0;top:0;height:38px;background-color:#036;color:#c8c8c8;box-shadow:3px 3px 10px gray">
            <div style="position:absolute;background-color:#036;right:0;height:38px">
                ...
                <div id="fileButton" class="icon4 topButton" title="分享檔案" style="display:none" onclick="fileButtonClick()"></div>
                <div id="camButton" class="icon2 topButton" title="激活相機和麥克風" style="display:none" onclick="camButtonClick()"></div>
            ...
            <div style="padding-top:9px;padding-left:6px;font-size:20px;display:inline-block"><b><span id="xtitle">網格信使</span></b></div>
        </div>
        ...
        <div id="xbottom" style="position:absolute;left:0;right:0;bottom:0px;height:30px;background-color:#036">
            ...
            <input type="button" id="sendButton" value="發送" style="position:absolute;right:110px;width:100px;top:4px;" onclick="xsend(event)">
            <input type="button" id="clearButton" value="明確" style="position:absolute;right:5px;width:100px;top:4px;" onclick="displayClear()">
        </div>
        ...
        <script type="text/javascript" onunload="onUnLoad()">
            ...
            function displayRemote(msg) {
                ...
                if (Notification && (windowFocus == false) && (Notification.permission == 'granted')) {
                    if (notification != null) { notification.close(); notification = null; }
                    if (args.title) {
                        notification = new Notification("網格信使" + ' - ' + args.title, { body: msg });
                    } else {
                        notification = new Notification("網格信使", { body: msg });
                    }
                }
            }
            ...
            function startFileUpload(file) {
                ...
                chatTextSession += ((new Date()).toLocaleTimeString() + ' - ' + "上載" + '> ' + file.name + ' (' + file.size + ' ' + "個字節" + ')\r\n');
            ...
            function startFileDownload(file) {
                ...
                chatTextSession += ((new Date()).toLocaleTimeString() + ' - ' + "下載" + '> ' + file.name + ' (' + file.size + ' ' + "個字節" + ')\r\n');
            ...
            function saveChatSession() {
                saveAs(data2blob(chatTextSession), "聊天會話");
            }
