    ...
    <div id="main" class="container" style="position:absolute;top:0px;right:0;left:0;bottom:0px">
        <div class="middleContainer">
            ...
            <table class="signinform">
                ...
                <tr>
                    <td><label for="inputDomain" class="formLabel">域</label></td>
                    <td style="text-align:right"><input type="text" id="inputDomain" class="formControl" placeholder="域"></td>
                </tr>
                <tr>
                    <td><label for="inputUsername" class="formLabel">用戶名</label></td>
                    <td style="text-align:right"><input type="text" id="inputUsername" class="formControl" placeholder="用戶名"></td>
                </tr>
                <tr>
                    <td><label for="inputPassword" class="formLabel">密碼</label></td>
                    <td style="text-align:right"><input type="password" id="inputPassword" class="formControl" placeholder="密碼"></td>
                </tr>
                <tr>
                    <td colspan="2"><button class="connectButton" onclick="return connect()">連接</button></td>
                </tr>
            </tbody></table>
        </div>
    </div>
