...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" class="arg_hide login">
    ...
    <script>
        ...
        function startup() {
            ...
            var okmessages = ['', "If valid, reset mail sent.", "ईमेल भेजा।", "ईमेल सत्यापन की आवश्यकता है, अपने मेलबॉक्स की जांच करें और पुष्टि लिंक पर क्लिक करें।", "एसएमएस भेजा गया।"];
            var failmessages = ["खाता बनाने में असमर्थ।", "खाता सीमा तक पहुंच गया।", "इस ईमेल पते के साथ मौजूदा खाता।", "अमान्य खाता निर्माण टोकन।", "उपयोगकर्ता का नाम पहले से मौजूद है।", "पासवर्ड खारिज कर दिया, एक अलग का उपयोग करें।", "अवैध ईमेल।", "खता नहीं मिला।", "अमान्य टोकन, पुनः प्रयास करें।", "ईमेल भेजने में असमर्थ।", "खाता बंद।", "पहुंच अस्वीकृत।", "लॉगिन विफल, उपयोगकर्ता नाम और पासवर्ड की जाँच करें।", "पासवर्ड परिवर्तन का अनुरोध किया।", "IP पता अवरुद्ध, बाद में पुन: प्रयास करें।"];
            if (messageid > 0) {
                var msg = '';
        ...
        function useEmailToken() {
            ...
            setDialogMode(1, "सुरक्षित लॉगइन", 3, useEmailKeyEx, "प्राप्त ईमेल पते पर टोकन भेजें?");
        }
