                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:30px;left:0;right:0;bottom:0px;background-color:#aaa">
                        <div style="margin:4px">
                            ...
                            <input id="SearchInput" type="text" placeholder="Filtre" onchange="onDeviceSearchChanged(event)" onkeyup="onDeviceSearchChanged(event)" autocomplete="off">&nbsp;
                        ...
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:25px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div style="margin-left:3px">
                                    <input type="button" id="connectbutton1" value="Se connecter" onclick="connectDesktop(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled">
                                    ...
                                    <input type="button" id="disconnectbutton1" value="Déconnecter" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false">
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:25px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    ...
                                    <input type="button" onkeypress="return false" onkeydown="return false" value="Actions de puissance ..." onclick="showPowerActionDlg()" style="display:none">
                                    <input type="button" id="DeskSpecialKeys" value="Touches" onkeypress="return false" onkeydown="return false" onclick="sendSpecialKeys()">
                                    <input type="button" id="DeskSoftKeys" value="Clavier" onkeypress="return false" onkeydown="return false" onclick="toggleSoftKeys(1)">
                                    <input type="button" id="DeskScreens" value="Écrans" onkeypress="return false" onkeydown="return false" onclick="deskSelectScreens()" style="display:none">
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    ...
                    <div style="margin:3px 0 3px 0">
                        ...
                        <div style="height:20px">Qualité</div>
                    </div>
                    <div style="margin:3px 0 3px 0">
                        ...
                        <div style="height:20px">Mise à l'échelle</div>
                    </div>
                    <div style="margin:3px 0 3px 0">
                        ...
                        <div style="height:20px">Taux</div>
                    </div>
                </div>
                <div id="d7amtkvm">
                    ...
                    <div style="height:60px">
                        <div style="float:right;border:1px solid #666;width:200px;height:60px;overflow-y:scroll;background-color:white">
                            <label><input type="checkbox" id="d7showfocus">Afficher l'outil de mise au point</label><br>
                            <label><input type="checkbox" id="d7showcursor">Afficher le curseur local</label><br>
                        </div>
                        <div>Autre</div>
                    </div>
                </div>
    ...
    <script>
        ...
        function account_showChangePassword() {
            ...
            if (passRequirements) {
                ...
                if (rc > 0) { x += '<br /><span style=font-size:x-small>' + format("Exigences: {0}.", r.join(', ')) + '</span>'; }
            }
            x += '<br />';
        ...
        function account_createMesh() {
            ...
            x += addHtmlValue("Type", '<div style=width:170px;margin:0;padding:0><select id=dp3meshtype style=width:100% onchange=account_validateMeshCreate() ><option value=2>' + "Groupe d'agents logiciels" + '</option><option value=1>' + "Intel® AMT uniquement" + '</option></select></div>');
            ...
            for (var i in nodes) {
                ...
                if (sort == 0) {
                    ...
                    if (((meshes[nodes[i].meshid]?nodes[i].meshid:'*') != current)) {
                        deviceHeaderSet();
                        var extra = '';
                        if ((meshes[nodes[i].meshid] != null) && (meshes[nodes[i].meshid].mtype == 1)) { extra = '<span style=color:lightgray>' + ", Intel® AMT uniquement" + '</span>'; }
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype == 1) { r += '<div style=padding:10px><i>' + "Aucun appareil Intel® AMT dans ce groupe"; }
                        if (mesh.mtype == 2) { r += '<div style=padding:10px><i>' + "Aucun appareil dans ce groupe"; }
                        r += '.</i></div></div>';
                        current = mesh._id;
                        count++;
                    }
        ...
        var powerStateStrings = ['', "Alimenté", "Dormir", "Dormir", "Veuille profonde", "Veille prolongée", "Arrêt progressif", "Présent"];
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if (node.intelamt != null) {
                    ...
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("Etat inconnu") + '</i>, v' + EscapeHtml(node.intelamt.ver); } else
                    ...
                    if (node.intelamt.state == 2) {
                        if (node.intelamt.user == null || node.intelamt.user == '') {
                            if ((meshrights & 4) != 0) {
                                str += ', <i style=color:#FF0000;cursor:pointer onclick=editDeviceAmtSettings("' + node._id + '")>' + nobreak("Aucun certificat") + '</i>';
                            } else {
                ...
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("Mots clés", '<span onclick=showEditNodeValueDialog(3) style=cursor:pointer>' + groupingTags + '</span>');
                } else {
                    x += addDeviceAttribute("Mots clés", groupingTags);
                }
                ...
                if ((connectivity & 2) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += '<span style=font-size:10px>' + "Intel® AMT connecté" + '</span>'; }
                else if ((connectivity & 4) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += '<span style=font-size:10px>' + "Intel® AMT detecté" + '</span>'; }
                if ((connectivity & 16) != 0) { if (powerstate.length > 0) { powerstate += '<br/>'; } powerstate += '<span style=font-size:12px>' + "Canal MQTT connecté" + '</span>'; }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype == 2) && (currentNode.agent.caps & 4))) { menus.push({ n: "Dossiers", f: 'setupDeviceMenu(2)' }); }
            if ((currentDevicePanel != 3) && (currentNode != null)) { menus.push({ n: "Détails", f: 'setupDeviceMenu(3)' }); }
        ...
        function deviceActionFunction() {
            ...
            if ((meshrights & 64) != 0) { y += '<option value=100>' + "Réveil" + '</option>'; } // Wake-up permission
            if ((meshrights & 8) != 0) { y += '<option value=4>' + "Mettre en veille" + '</option><option value=3>' + "Réinitialiser" + '</option><option value=2>' + "Éteindre" + '</option>'; } // Remote control permission
            y += '</select>';
        ...
        function editDeviceAmtSettings(nodeid, func) {
            ...
            setDialogMode(2, "Éditer les certificats Intel® AMT", buttons, editDeviceAmtSettingsEx, x, { node: node, func: func });
        ...
        */
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            if ((hardware.windows && hardware.windows.osinfo) || node.osdesc) {
                ...
                if (x != '') { sections.push({ name: "Système d'exploitation", html: x, img: 'software32.png' }); }
            }
            ...
            if (hardware.identifiers) {
                ...
                if (x != '') { sections.push({ name: "Carte mère", html: x, img: 'motherboard32.png' }); }
            }
            ...
            if (hardware.windows) {
                if (hardware.windows.memory) {
                    ...
                    if (x != '') { sections.push({ name: "Mémoire", html: x, img: 'ram32.png' }); }
                }
            }
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                if (x != '') { sections.push({ name: "Espace de rangement", html: x, img: 'storage32.png' }); }
            }
        ...
        function p20updateMesh() {
            ...
            if (currentMeshLinks && ((currentMeshLinks.rights & 2) != 0)) { x += '<div style=margin-bottom:6px><a onclick=p20showAddMeshUserDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Ajouter un utilisateur" + '</a></div>'; }
        ...
        function p20viewuser(userid) {
            ...
            if (meshrights == 0xFFFFFFFF) r.push("Administrateur Complet"); else {
                ...
                if ((meshrights & 2048) != 0) r.push("Pas d'appareil Intel® AMT");
