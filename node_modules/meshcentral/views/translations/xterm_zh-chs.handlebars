...
<body style="overflow:hidden;background-color:black" oncontextmenu="handleContextMenu(event)">
    ...
    <div id="termShellContextMenu" class="contextMenu noselect" style="display:none;min-width:0px">
        <div id="cxtermnorm" class="cmtext" onclick="cmtermaction(1,event)"><b>管理員外殼</b></div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(6,event)">管理員PowerShell</div>
        <div id="cxtermunorm" class="cmtext" onclick="cmtermaction(8,event)">用戶外殼</div>
    ...
    <div id="termShellContextMenuLinux" class="contextMenu noselect" style="display:none;min-width:0px">
        <div id="cxtermnorm" class="cmtext" onclick="cmtermaction(1,event)"><b>根殼</b></div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(8,event)">用戶外殼</div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(100,event)">登錄外殼</div>
    </div>
        ...
        <div id="deskarea0" style="position:relative">
            <div id="deskarea1" class="areaHead">
                ...
                <div>
                    ...
                    <input id="DisconnectButton" type="button" value="斷開" onclick="connectButton()">
