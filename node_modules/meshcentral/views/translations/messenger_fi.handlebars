<!DOCTYPE html><html lang="fi" style="height:100%"><head>
    ...
    <body style="font-family:Arial,Helvetica,sans-serif">
        ...
        <div id="xbottom" style="position:absolute;left:0;right:0;bottom:0px;height:30px;background-color:#036">
            ...
            <input type="button" id="sendButton" value="Lähetä" style="position:absolute;right:110px;width:100px;top:4px;" onclick="xsend(event)">
            <input type="button" id="clearButton" value="Tyhjennä" style="position:absolute;right:5px;width:100px;top:4px;" onclick="displayClear()">
        </div>
        ...
        <script type="text/javascript" onunload="onUnLoad()">
            ...
            function startFileUpload(file) {
                ...
                chatTextSession += ((new Date()).toLocaleTimeString() + ' - ' + "Upload" + '> ' + file.name + ' (' + file.size + ' ' + "tavua" + ')\r\n');
