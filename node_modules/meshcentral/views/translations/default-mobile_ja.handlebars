...
<body onload="if (typeof(startup) !== 'undefined') startup();" style="overflow-y:hidden;margin:0;padding:0;border:0;color:black;font-size:13px;font-family:\'Trebuchet MS\', Arial, Helvetica, sans-serif">
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:30px;left:0;right:0;bottom:0px;background-color:#aaa">
                        <div style="margin:4px">
                            <span style="width:20px;display:inline-block;text-align:center;cursor:pointer" onclick="clearSearchInput()"><b>バツ</b></span>
                            <input id="SearchInput" type="text" placeholder="フィルタ" onchange="onDeviceSearchChanged(event)" onkeyup="onDeviceSearchChanged(event)" autocomplete="off">&nbsp;
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:25px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    ...
                                    <input type="button" id="DeskSoftKeys" value="キーボード" onkeypress="return false" onkeydown="return false" onclick="toggleSoftKeys(1)">
    ...
    <script>
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if (node.intelamt != null) {
                    ...
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("不明な状態") + '</i>, v' + EscapeHtml(node.intelamt.ver); } else
                ...
                if ((meshrights & 76) != 0) { x += '<input type=button value=\"' + "行動" + '\" onclick=deviceActionFunction() />'; }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype == 2) && (currentNode.agent.caps & 4))) { menus.push({ n: "ファイル", f: 'setupDeviceMenu(2)' }); }
            if ((currentDevicePanel != 3) && (currentNode != null)) { menus.push({ n: "詳細", f: 'setupDeviceMenu(3)' }); }
        ...
        */
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            if ((hardware.windows && hardware.windows.osinfo) || node.osdesc) {
                ...
                if (x != '') { sections.push({ name: "オペレーティング・システム", html: x, img: 'software32.png' }); }
            }
            ...
            if (node.agent) {
                ...
                if (x != '') { sections.push({ name: "メッシュエージェント", html: x, img: 'meshagent32.png' }); }
            }
            ...
            if (node.intelamt != null) {
                ...
                if (x != '') { sections.push({ name: "インテル&reg;アクティブ管理テクノロジー（インテル&reg;AMT）", html: x, img: 'amt32.png' }); }
            }
            ...
            if (hardware.identifiers) {
                ...
                if (x != '') { sections.push({ name: "マザーボード", html: x, img: 'motherboard32.png' }); }
            }
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                if (x != '') { sections.push({ name: "ストレージ", html: x, img: 'storage32.png' }); }
            }
